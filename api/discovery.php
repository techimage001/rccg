...
$type=((string)($_GET['type']??'student'))==='teacher'?'teacher':'student';
...
if(!file_exists($file)){
  api_json(['ok'=>true,'available'=>false,'manual_type'=>$type,'lesson'=>$meta,'message'=>ucfirst($type).' Manual content has not yet been loaded into the private '.$year.' folder. The lesson date and title are verified.']);
}
