...
<div class="app">
  <header class="topbar">
    ...
    <div class="top-actions">
      <button class="icon-btn" id="shareApp" aria-label="Share this WebApp">↗</button>
      <button class="icon-btn" id="installApp" hidden aria-label="Install WebApp">＋</button>
  ...
  <div class="desktop-shell">
    <aside class="sidebar" aria-label="Main navigation">
      ...
      <div class="side-group"><h3>Get involved</h3>
        ...
        <a class="side-link" href="#/form/pastor" data-route="form/pastor">👤 Speak With Pastor</a>
    ...
    <main class="content" id="main">
      ...
      <section class="page-panel" data-page="discovery">
        <div id="discoveryBrowse">
          ...
          <div class="section-head"><div><h1 class="page-title">Discovery Class</h1><p class="lede">Student and Teacher manuals, including past and future published lessons.</p></div><button class="btn btn-gold" data-donate>❤ Donate</button></div>
          <div class="subnav"><button class="btn btn-primary">Student Manual</button><button class="btn">Teacher Manual</button><button class="btn">Past Lessons</button><button class="btn">Future Lessons</button></div>
          <section class="section calendar-wrap">
            <div class="card calendar-card"><h2>Choose a lesson date</h2><p class="lede">Pick any published Sunday — past, current or future.</p><input id="lessonDate" type="date"><p id="lessonDateStatus" class="help"></p><p class="help">Future lessons appear when the church publishes or schedules them.</p></div>
            <div><h2>All Published Lessons</h2><div class="lesson-list" id="lessonList"></div></div>
          </section>
        </div>
        <div id="lessonView" style="display:none"></div>
      </section>

      <section class="page-panel" data-page="whats-on"><div class="breadcrumb"><a href="#/home" data-route="home">Home</a> / What's On</div><div class="section-head"><div><h1 class="page-title">What's On</h1><p class="lede">Upcoming church activities, automatically surfaced from the private content database.</p></div><button class="btn btn-gold" data-donate>❤ Donate</button></div><div class="section lesson-list" id="eventsList"></div></section>

      <section class="page-panel" data-page="service-times"><div class="breadcrumb"><a href="#/home" data-route="home">Home</a> / Service Times</div><div class="section-head"><div><h1 class="page-title">Service Times</h1><p class="lede">Sunday, Wednesday and monthly programme.</p></div><button class="btn btn-gold" data-donate>❤ Donate</button></div><div class="section lesson-list" id="serviceTimes"></div></section>

      <section class="page-panel" data-page="contact"><div class="breadcrumb"><a href="#/home" data-route="home">Home</a> / Contact & Join</div><div class="section-head"><div><h1 class="page-title">Contact & Join</h1><p class="lede">Open external links separately so the WebApp stays open underneath.</p></div><button class="btn btn-gold" data-donate>❤ Donate</button></div><div class="section" id="churchInfo"></div></section>

      <section class="page-panel" data-page="forms"><div id="formHost"></div></section>
    </main>
  </div>

  <button class="donate-fab" data-donate>❤ Donate</button>
  ...
  <div class="drawer" id="drawer" aria-hidden="true"><div class="drawer-panel"><div class="drawer-head"><strong>RCCG Open Heavens Fife</strong><button class="icon-btn" id="closeDrawer">✕</button></div>
    ...
    <div class="drawer-group"><h3>Connect</h3><a class="drawer-link" data-route="form/prayer" href="#/form/prayer">🙏 Prayer Request</a><a class="drawer-link" data-route="form/pastor" href="#/form/pastor">👤 Speak With Pastor</a><a class="drawer-link" data-route="form/ministry" href="#/form/ministry">🤝 Join a Ministry</a><a class="drawer-link" data-route="form/sponsorship" href="#/form/sponsorship">❤️ Sponsor a Child</a><a class="drawer-link" data-route="form/suggestion" href="#/form/suggestion">💡 Send a Suggestion</a><button class="drawer-link" style="width:100%;border:0;background:transparent" data-donate>❤ Donate</button></div>
  </div></div>
...
<script>document.addEventListener('DOMContentLoaded',()=>{document.getElementById('mobileMore')?.addEventListener('click',()=>document.getElementById('drawer').classList.add('open'));document.querySelectorAll('[data-route],[data-donate]').forEach(()=>{});});</script>
</body>
</html>
